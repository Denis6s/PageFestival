...
export function css(done) {
  src("src/scss/app.scss", { sourcemaps: true }) //ubicar el archivo
    .pipe(sass({ outputStyle: "compressed" }).on("error", sass.logError)) //compilamos - agregamos performance
...
export default series(imagenes, crop, js, css, dev); //Series me sirve para ejecutar multiples tareas
